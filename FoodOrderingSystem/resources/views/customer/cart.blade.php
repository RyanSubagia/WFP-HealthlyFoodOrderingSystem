                    ...
                    <table class="table table-bordered align-middle bg-white">
                        ...
                        <tbody>
                            ...
                            @foreach ($carts as $item)
                                ...
                                @endphp
                                <tr>
                                    <td><img src="{{ asset('storage/menu_sushi/' . $item->food->image) }}" class="img-fluid"
                                    ...
                                    <td>
                                        ...
                                        @foreach ($condiments as $c)
                                            @if ($item->$c)
                                                <span
                                                    class="badge bg-secondary mt-1">{{ ucfirst(str_replace('_', ' ', $c)) }}</span>
                                            @endif
                                        @endforeach
                                    </td>
                                    ...
                                    <td>
                                        <button class="btn btn-danger"
                                            onclick="deleteCartItem({{ $item->id }})">✕</button>
                                    </td>
                                </tr>
                            @endforeach
                            <tr>
                ...
                <form action="{{ route('customer.cart.checkout') }}" method="POST">
                    ...
                    <div class="form-check mb-3">
                        ...
                        <label class="form-check-label" for="use_points">
                            Use Poin? You had {{ auth()->user()->poin }} poin,  (MAX discount 50%)
                        </label>
                    </div>
